public class Lab21_5 {
   ...
   public static long squareSum(int max)
   {
	   ...
	   for(int i = 1; i <= max; i++)
	   { 
		   System.out.println("squareSum " + i + " value "  + (i*i + previous_Value));
		   previous_Value = i * i + previous_Value;
	   }
  ...
  public static long squareSum(long[] arr, int max)
   ...
   public static long fib(int max)
   {
	   ...
	   for(int i = 2; i <= max; i++)
	   {
		   ...
		   System.out.println("Fibonacci " + i + " is " + total);
		   previous = current;
		   current = total;
   ...
   public static long fib(long[] arr, int max)
   {
	   ...
	   for(int i = 2; i <= max; i++)
	   {
		   if(arr[i] == 0)
		   {
			   ...
			   System.out.println("Fiboncci [" + i + "] is" + arr[i]);
		   }
   ...
   public static long factorial(int max)
   {
	   ...
	   {
		   subtotal = subtotal * i;
		   System.out.println("Factorial " + i + " is " + subtotal);
	   }
	   return subtotal;
   }
   ...
   public static long factorial(long[] arr, int max)
   {
	   ...
	   for(int i = 2 ; i <= max; i++)
	   {
		   ...
		   {
			   arr[i] = arr[i-1] * i;
			   System.out.println("Factorial [" + i + "] is " + arr[i]);
		   }
	   }
